...
module regfile(
    input             clk,
    input             wen,//回写的使能信号
    input      [4 :0] raddr1,//rs1地址
    input      [4 :0] raddr2,//rs2地址
    input      [4 :0] waddr,//rd地址
    input      [31:0] wdata,//要回写的数据
    output reg [31:0] rdata1,//rs1数据
    output reg [31:0] rdata2,//rs2数据
    input      [4 :0] test_addr,//测试地址
    output reg [31:0] test_data//测试数据
    );
    reg [31:0] rf[31:0];//32个位宽32的寄存器
