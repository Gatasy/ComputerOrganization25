...
HD_PWD='E:/NItemp/25CourseComputerArchitecture/ComputerOrganization25/Soc/Soc.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log data_init.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source data_init.tcl
