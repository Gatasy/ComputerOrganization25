...
HD_PWD='E:/NItemp/25CourseComputerArchitecture/ComputerOrganization25/Soc/Soc.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log data_init.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source data_init.tcl -notrace
