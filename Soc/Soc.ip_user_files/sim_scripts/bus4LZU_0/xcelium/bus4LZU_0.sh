...
#
# Script generated by Vivado on Sat Apr 19 22:44:49 +0800 2025
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : bus4LZU_0.sh
...
#
# Usage        : bus4LZU_0.sh
#                bus4LZU_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                bus4LZU_0.sh [-reset_run]
#                bus4LZU_0.sh [-reset_log]
#                bus4LZU_0.sh [-help]
#
...
#                script (type 'bus4LZU_0.sh -help' for more information).
#
...
design_libs_elab="-libname blk_mem_gen_v8_4_8 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver blk_mem_gen_v8_4_8 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "bus4LZU_0.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./bus4LZU_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work blk_mem_gen_v8_4_8 $xmvlog_opts +incdir+"../../../../Soc.gen/sources_1/ip/bus4LZU_0/sources_1/new/header" \
  "../../../ipstatic/simulation/blk_mem_gen_v8_4.v" \
  2>&1 | tee compile.log; cat .tmp_log > xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../Soc.gen/sources_1/ip/bus4LZU_0/sources_1/new/header" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.bus4LZU_0 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.bus4LZU_0 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log bus4LZU_0_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./bus4LZU_0.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: bus4LZU_0.sh [-help]\n\
Usage: bus4LZU_0.sh [-step]\n\
Usage: bus4LZU_0.sh [-lib_map_path]\n\
Usage: bus4LZU_0.sh [-reset_run]\n\
Usage: bus4LZU_0.sh [-reset_log]\n\
Usage: bus4LZU_0.sh [-keep_index]\n\
Usage: bus4LZU_0.sh [-noclean_files]\n\n\
