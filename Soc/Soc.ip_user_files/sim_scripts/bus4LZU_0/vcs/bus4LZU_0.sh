...
design_libs=(blk_mem_gen_v8_4_8 xil_defaultlib)
...
compile()
{
  vlogan -work blk_mem_gen_v8_4_8 $vlogan_opts +v2k +incdir+"../../../../Soc.gen/sources_1/ip/bus4LZU_0/sources_1/new/header" \
  "../../../ipstatic/simulation/blk_mem_gen_v8_4.v" \
  2>&1 | tee compile.log; cat .tmp_log > vlogan.log 2>/dev/null

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../Soc.gen/sources_1/ip/bus4LZU_0/sources_1/new/header" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.bus4LZU_0 xil_defaultlib.glbl -o bus4LZU_0_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./bus4LZU_0_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key bus4LZU_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc bus4LZU_0_simv.daidir vcs_lib c.obj)
