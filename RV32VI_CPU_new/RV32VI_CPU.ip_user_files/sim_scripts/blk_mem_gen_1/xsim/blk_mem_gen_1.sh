...
#
# Script generated by Vivado on Wed Apr 02 15:15:12 +0800 2025
...
# script info
echo -e "blk_mem_gen_1.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_8 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot blk_mem_gen_1 xil_defaultlib.blk_mem_gen_1 xil_defaultlib.glbl -log elaborate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/FGPA/Vivado/2024.1/data/xsim"
  fi
